...
export const PhoneShowCase = ({ mobileOne, mobileTwo }) => {
                ...
                <Container>
                    <div className={phoneStyles.phoneListing}>
                        <div className={phoneStyles.slide}>
                            <Img alt='project mobile view' className={phoneStyles.mobileImg} fluid={mobileOne.childImageSharp.fluid}/>
                        </div>
                        <div className={phoneStyles.slide}>
                            <Img alt='project mobile view' className={phoneStyles.mobileImg} fluid={mobileTwo.childImageSharp.fluid}/>
                        </div>
                    </div>
                </Container>
            </section>
